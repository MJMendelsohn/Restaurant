...
SELECT name FROM Restaurant r, DinesAt d, RestaurantAt ra WHERE ra.zip_code = 12345 AND r.attire = 'formal' AND r.price_range = 3 AND r.alcohol = 't' AND r.sit_down = 't' AND d.dining_date != 'NULL' AND r.rest_id = d.rest_id AND ra.rest_id = d.rest_id AND ra.rest_id = r.rest_id;
